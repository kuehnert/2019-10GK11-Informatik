...
public class KartenAutomat {
    ...
    public KartenAutomat(int newkartenpreiskind, int newkartenpreiserw){ 
        kartenpreiskind = newkartenpreiskind;
        kartenpreiserw = newkartenpreiserw;
        zeigeMenu();
    }
    ...
    public void druckeKarte() {
        ...
        System.out.println("| und für " + anzahlKartenkind + " Kinder.                      |");
        System.out.println("| Gesamtpreiß der Karte: " + gesamtpreis + "€             |");
        System.out.println("___________________________________________");
    }

    public void zeigeMenu() {
        System.out.println("Willkommen im Phantasialand! \n\nDas ist unsere Kartenliste:");
        System.out.println("Erwachsener             " + kartenpreiserw +"€");
        System.out.println("Kind (bis 14 Jahre)    " + kartenpreiskind +"€");
        System.out.println("Wieviele Erwachsenen Karten möchten sie haben?");
        ...
        if (anzahlKartenkind > 0 && anzahlKartenerw <= 0){
            System.out.println("Tut und leid, aber Kinder dürfen in unseren Park nur in Begleitung eines Erwachsenen.");
            while (anzahlKartenkind >0 && anzahlKartenerw <= 0){
                System.out.println("Wieviele Erwachsenen Karten möchten sie haben?");
                anzahlKartenerw = input.nextInt();
                gesamtpreis = kartenpreiserw * anzahlKartenerw;
                System.out.println("Wieviele Kinder Karten möchten sie haben?");
    ...
    public void nimmGeldAn() {
        ...
        while (x > 0){
            ...
            eingeworfenesGeld == 100 || eingeworfenesGeld == 200 || eingeworfenesGeld ==  500) {
                ...
                if(x<=0){
                    System.out.println("Ihre Karte wird gedruckt.");
                }
            }
            else{
                System.out.println("Das ist kein Zulässiges Geld. Der zu Zahlende Betrag beträgt noch " + x + "€.");
            }
        }
        druckeKarte();
    }
